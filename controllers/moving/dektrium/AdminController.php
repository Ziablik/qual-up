...
use app\modules\progress\controllers\WorkBoardController;
...
class AdminController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($user->load(\Yii::$app->request->post()) && $user->create()) {
            ...
            if ($user_program->load(Yii::$app->request->post())){
                $user_program->user_id = $user->id;
                $user_program->save();
                WorkBoardController::actionProgressGenerate($user->id, $user_program);
            }
