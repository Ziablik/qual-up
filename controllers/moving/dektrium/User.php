...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return $this->hasMany(Programs::className(), ['id' => 'program_id'])->viaTable('user_program', ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Themes::className(), ['id' => 'theme_id'])->viaTable('user_theme', ['user_id' => 'id']);
    }
